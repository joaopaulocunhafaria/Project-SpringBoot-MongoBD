...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post(  "Partiu viagem", "Vou viajar para São Paulo. Abraços!",sdf.parse("21/03/2018"), maria);
		Post post2 = new Post("Bom dia", "Acordei feliz hoje!",  sdf.parse("21/03/2018"),maria);
